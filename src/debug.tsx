	...
	return <>
		<div className="flex flex-col gap-4">
			<div className="flex items-center gap-4">
				...
				<Button onClick={() => {
					invoke("lcu_post_request", { url: "/lol-challenges/v1/update-player-preferences", body: { ...riot_challenge_data.preferences, "challengeIds": [0, 303204, 0] } }).then(x => console.log(x));
				}}>set buttons</Button>
				<Button onClick={() => {
